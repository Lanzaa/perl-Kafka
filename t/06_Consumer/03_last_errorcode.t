...
# NAME: Test of the method Kafka::Consumer::last_errorcode
...
ok( !defined( $consumer->last_errorcode ), "not defined last_errorcode" );
throws_ok { $consumer->fetch() } qr/^Mismatch argument/, 'expecting to die: Mismatch argument';
ok( defined( $consumer->last_errorcode ), "defined last_errorcode = ".$consumer->last_errorcode );
